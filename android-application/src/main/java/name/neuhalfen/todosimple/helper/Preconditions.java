...
This is a complete copy of Guavas Precondition. Including guava in the build fails for debug builds, bc. the 12k+ methods of guava break the 65k limit of methods in dex.

Proguard removes them - but not in debug mode.
