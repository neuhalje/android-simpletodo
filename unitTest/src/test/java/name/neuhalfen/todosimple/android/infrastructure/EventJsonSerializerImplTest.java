...
import name.neuhalfen.todosimple.android.infrastructure.json.*;
...
public class EventJsonSerializerImplTest {
    ...
    private final static UUID uuid1 = UUID.fromString("11111111-1111-1111-1111-111111111111");
    private final static UUID uuid2 = UUID.fromString("22222222-2222-2222-2222-222222222222");
