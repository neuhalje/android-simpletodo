...
import name.neuhalfen.todosimple.domain.model.{Task, EventId, CommandId, TaskId}
...
object UnitSpec {
  ...
  val COMMAND_ID_ZERO = CommandId[Task]("00000000-cccc-0000-0000-000000000000")
  val COMMAND_ID_ONE = CommandId[Task]("11111111-cccc-1111-1111-111111111111")
  val COMMAND_ID_TWO = CommandId[Task]("22222222-cccc-2222-2222-222222222222")
  val COMMAND_ID_THREE = CommandId[Task]("33333333-cccc-3333-3333-333333333333")

  val EVENT_ID_ZERO = EventId[Task]("00000000-eeee-0000-0000-000000000000")
  val EVENT_ID_ONE = EventId[Task]("11111111-eeee-1111-1111-111111111111")
